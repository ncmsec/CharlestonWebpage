...
The map contains 121 places, including **Church and Union Charleston (97)**, **Vintage Lounge (98)**, **Cooper Coffee & Wine (99)** and the expanded coffee, barbecue, sushi, park and activity scouting set. The guide includes walking estimates, venue links, an event schedule, suggested days and walking loops. The site is responsive and needs no build service, database, API key or paid hosting plan.
...
- **index.html** — map homepage; embedded map libraries, street geometry and 121 place records.
